    ...
    def train(self, instruction, chosen_task_name, args):
        ...
        while current_iteration < self.maxiter:
            ...
            for j in range(args.num_offspring):
                ...
                print("parent_1", str(j),":\t", parent_1)
                print("parent_2", str(j),":\t", parent_2)
                ...
                if flag_error: 
                    ...
                    continue
                print("Offspring", str(j), ":\t", offspring)
                # meta_file.write("Offspring" + str(j) + ":\t " + offspring + '\n')
                if offspring not in self.W_candidates:
                    offspring_score = self.score(offspring, j+1, args=args)
                    ...
                    print("Offspring Score:\t", offspring_score)
                    print("Adding offspring in the population")
