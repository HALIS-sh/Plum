# import
from trainers import GA_trainer
...
class Pic_GA_trainer(GA_trainer.GA_trainer):
    ...
    def __init__(self, maxiter, patience, train_seed, seed, num_compose, num_candidates, num_tournaments ,backbone, task_type, pic_gen_seed):
        super(Pic_GA_trainer, self).__init__(maxiter, patience, train_seed, seed, num_compose, num_candidates,num_tournaments, backbone, task_type)
